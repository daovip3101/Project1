...
public class Badge extends FrameLayout {
    ...
    public Badge(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mBadgeTextSize = a.getDimensionPixelSize(R.styleable.NotificationBadge_nbTextSize, 20);
...
//                Drawable badgeBackground = a.getDrawable(R.drawable.ic_launcher_background);

            if (badgeBackground != null) {
                mIvBadgeBg.setImageDrawable(badgeBackground);
            }
            mIvBadgeBg.setImageResource(R.drawable.icon_badge);
